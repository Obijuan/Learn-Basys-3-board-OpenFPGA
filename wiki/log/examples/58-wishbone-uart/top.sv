...
//-- Sacar el byte recibido por los leds
...
//-- Leer los switches
logic [15:0] read_switches;
always_ff @( posedge(clk) ) begin
    if (T70)
        read_switches <= mem_bus.dat_miso[15:0];
end
...
always_comb begin
    ...
    //-- Write Leds
        ...
        //-- los pulsadores
        data_out = (read_switches[15]) ? 
            {read_switches[15:13], read_buttons[4:0], rx_byte} :
            {read_switches[15:8], rx_byte};
