...
//---------------------------------------------------------------
//-- Bucle principal del Bootloader
//--
//-- Se recibe un fichero .hex, se graba en memoria y se le
//-- pasa el control
//--
//-- En caso de error se muestra un mensaje y se termina 
//---------------------------------------------------------------
int __bootloader() {
    uint32_t base_address = 0;
    uint32_t start_address = (uint32_t) &__ram_start;

    //--- Mostrar un patron en los LEDs
    LEDS = 0xAAAA;
